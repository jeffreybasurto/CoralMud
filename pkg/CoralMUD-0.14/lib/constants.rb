...
# Levels aren't used for security any more.
# I just haven't gotten around to completely removing it.
# player levels
...
# pass a block to assert something as true.
# Examples:
# assert { 1 == 1 }
# assert { obj.is_a?(Player) }
# assert { damage < 100 }
def assert
