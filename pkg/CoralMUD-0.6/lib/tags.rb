...
r1= TestRoom.new("ugly.room", a1)
r2= TestRoom.new("ugly.room", a2)
tfound = Tag.find_any_obj 't.w::an.area::u.r'
log :debug, "#{tfound.count}" if tfound
log :debug, "#{Tag.gen_generic_tag(w1)}i"
